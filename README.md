...
* `SLURM_script.txt`: The Slurm batch script used to execute the code on the CSF3 A100 GPU nodes.
* `SLURM_output.txt`: The raw output log from the cluster showing the training progress, final AUC scores, and the bootstrapped p-value.
